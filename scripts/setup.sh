...
# ============================================================
# OfficeClaw / OfficeClaw — Interactive Setup
# 智能体咖啡交互式安装向导
#
...
echo ""
echo -e "${BOLD}🐱 OfficeClaw — Interactive Setup${NC}"
echo -e "${BOLD}智能体咖啡 — 交互式安装向导${NC}"
echo "=================================="
echo ""
...
echo ""
echo "OfficeClaw works with just a model API key."
echo "智能体咖啡只需一个模型 API Key 即可运行。"
echo ""
...
cat > "$ENV_FILE" <<ENVEOF
# Generated by OfficeClaw setup.sh — $(date +%Y-%m-%d)
# 由 setup.sh 自动生成
...
echo ""
echo "=================================="
echo -e "${GREEN}🎉 OfficeClaw is ready!${NC}"
echo ""
...
echo "  Issues: https://github.com/your-org/office-claw/issues"
echo ""
