...
describe('Phase F types', () => {
  describe('ActionStatus', () => {
    it('isValidActionStatus accepts valid statuses', async () => {
      const { isValidActionStatus } = await import('@clowder/shared');
  ...
  describe('PendingAction', () => {
    it('has status and requestedAt fields', async () => {
      const { isValidActionStatus } = await import('@clowder/shared');
      /** @type {import('@clowder/shared').PendingAction} */
      const action = {
        seatId: 'P1',
        actionName: 'kill',
        targetSeat: 'P3',
  ...
  describe('Ballot', () => {
    it('has required fields', async () => {
      /** @type {import('@clowder/shared').Ballot} */
      const ballot = {
        voterSeat: 'P1',
        choice: 'P3',
        revision: 1,
  ...
  describe('Resolution', () => {
    it('has required fields', async () => {
      /** @type {import('@clowder/shared').Resolution} */
      const resolution = {
        winningChoice: 'P3',
        tiePolicy: 'no_kill',
        revoteCount: 0,
  ...
  describe('GameEvent revealPolicy', () => {
    it('accepts revealPolicy field', async () => {
      /** @type {import('@clowder/shared').GameEvent} */
      const event = {
        eventId: 'e1',
        round: 1,
        phase: 'night_wolf',
