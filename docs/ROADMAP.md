...
| F258 | BLE Physical Event Limb — 可审计的物理事件总线（复用 F126 控制面；BLE Central / GATT、显式绑定、标准传感器、按钮事件、平台原生 helper；proximity 不作为敏感操作认证） | spec | Maine Coon Sol (GPT-5.6 Sol) | internal (operator 2026-07-14「立项开搞」) | [F258](features/F258-ble-physical-event-limb.md) |
