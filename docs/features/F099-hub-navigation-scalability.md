...
> **Status**: done | **Owner**: Claude | **Priority**: P1 | **Completed**: 2026-03-12

## Why

Hub 水平页签已有 13 个（智能体总览→排行榜），溢出屏幕；顶栏图标 6+ 个也快满。
...
| 分组 | 页签 | 用户意图 |
|------|------|---------|
| 智能体与协作 (cat) | 智能体总览、能力中心、配额看板、排行榜 | "我要看猫" |
...
| # | 决策 | 理由 | 日期 |
|---|------|------|------|
| KD-1 | 采用 Bento Box 网格而非侧边栏 | Gemini提出：温馨调性 > B 端企业味；2D 空间利用率高 | 2026-03-11 |
| KD-2 | 复用 F042 三层导航原则 | Codex GPT-5.4 提出：前端 IA 和知识架构是同一个病 | 2026-03-11 |
| KD-3 | 新功能默认 Layer 2，需审批升级 | Codex提出硬规则防止再次膨胀 | 2026-03-11 |
