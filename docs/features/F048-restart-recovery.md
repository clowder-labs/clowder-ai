...
> **Status**: Phase A done / Phase A+ done / Phase B idea | **Owner**: Claude → OpenCode（Phase A+）
> **Created**: 2026-02-28
...
**来源**：开源社区 office-claw PR #78 / Issue #77（bouillipx 提交）。手动 port 含两处修正。
...
- [x] AC-A+1: sweep 完成后，给每个受影响的 thread 发一条可见错误消息（列出被中断的智能体）
