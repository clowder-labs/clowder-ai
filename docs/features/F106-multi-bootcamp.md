...
> **Status**: done | **Owner**: Claude | **Priority**: P2 | **Completed**: 2026-03-12
...
2. **前端 CTA 逻辑调整**：
   ...
   - 无训练营 → "开始智能体训练营" → 打开列表 modal（空态 + 创建按钮）
...
- [x] AC-A5: 空消息态 CTA 适配：有训练营→"我的训练营(N)"打开列表 modal，无训练营→"开始智能体训练营"打开列表 modal（显示空态+创建按钮）
