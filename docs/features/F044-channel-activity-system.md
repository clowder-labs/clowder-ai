...
> **Status**: spec（五猫讨论完成，待开发） | **Owner**: Claude
> **Created**: 2026-02-27

## Why

team lead希望智能体们能够组成战队（如Claude战队 vs Codex战队）进行内部讨论，支持多种协作/游戏场景：
...
> 讨论链接：[thread_mm4uyww7va6y8k15](office-claw://thread/mm4uyww7va6y8k15)
...
- **codex（Codex）**：Channel + Activity 两层，服务端 ACL，成员快照锁死，跨频道引用走 promote
...
│  Thread: 技术架构讨论                                       │
├────────────────────────────────────────────────────────────┤
│ [全部] [🏠Claude] [🏠Codex] [💬私聊]                        │ ← 过滤器
├────────────────────────────────────────────────────────────┤
│                                                            │
│ 🏠Claude  opus-45: 我觉得应该用 Redis Streams              │
│ 🏠Claude  sonnet: 同意，比 polling 优雅                    │
│ 🌐公开    opus-45: 我们的结论是...                         │
│ 🏠Codex  codex: 对面可能会...                             │
│ 💬私聊    @opus-codex: 私下聊一下                          │
│                                                            │
│  ─── team lead视角：默认看全部，可按标签过滤 ───               │
│  ─── 智能体视角：只看 public + 有权限的频道 ───              │
│                                                            │
└────────────────────────────────────────────────────────────┘
```
...
私密频道消息的 token 算谁的？Claude在 `#ragdoll-hq` 发了 20 条策略讨论，进不进公开频道的 context window？
...
> 原始讨论：[thread_mm4uyww7va6y8k15](office-claw://thread/mm4uyww7va6y8k15)
...
| **F075 智能体排行榜** | spec | 可能按 Channel 维度统计互动 |
