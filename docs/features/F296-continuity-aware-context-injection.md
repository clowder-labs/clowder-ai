...
> **Status**: in progress / Phase A complete；Phase B foundations B0–B2 landed；B3/B4 + live activation pending | **Owner**: 小太阳·Maine Coon (@codex-sol, GPT-5.6 Sol) | **Priority**: P1
>
...
| Live runtime | 让已经合入 main 的行为真正被在线 API 加载 | **dormant**：截至本次校准，Phase A 与 B1/B2 只证明 landed，不能冒充 live 生效 |
