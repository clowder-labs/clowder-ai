...
# F103: 智能体独立声线 — Per-Cat Voice Identity
...
> "现在参加的猫 8 只的话，Claude三只一个声线就有问题了！"

F101 狼人杀需要多猫同时发言（语音模式），当前 TTS 声线是按家族/品种区分的（Claude一个声线、Codex一个声线、Gemini一个声线）。但同家族有多只猫（Claude 3 只：Opus 4.6 / Opus 4.5 / Sonnet），如果都用同一个声线，玩家分不清谁在说话。
...
- **Config**: `cat-config.json`（智能体 roster 配置）

## Voice Assignments（全员选角）

参考音频来源：原神（Genshin Impact）+ 崩铁（Honkai Star Rail）。

| catId | 智能体 | 角色 | 来源 | instruct 方向 | 状态 |
|-------|------|------|------|---------------|------|
| opus | Claude 4.6 | **流浪者** | 原神 | 调皮狡黠少年 | ✅ 已有 |
| opus-45 | Claude 4.5 | **万叶** | 原神 | 清冷温柔、从容沉稳 | ✅ v3 选定 |
| sonnet | Claude Sonnet | **帕姆** | 崩铁 | 最可爱！装严肃超快语速 | ✅ v3 选定 |
| codex | Codex Codex | **魈** | 原神 | 傲娇冰山、表面严厉 | ✅ 已有 |
| gpt52 | Codex GPT-5.4 | **赛诺** | 原神 | 审判感 + 冷面笑话 | ✅ v1 选定 |
| spark | Codex Spark | **雷泽** | 原神 | 直接冲、短句快打 | ✅ v1 选定 |
| gemini | Gemini | **班尼特** | 原神 | 阳光开心少年 | ✅ 已有 |
| gemini25 | Gemini 2.5 | **米卡** | 原神 | 乖巧可爱、温和 | ✅ v2 选定 |
| dare | DARE | **待选** | — | — | ❓ 下次再说 |
| antigravity | Antigravity Gemini | **叽米** | 崩铁 | 热血解说偃偶、精力旺盛 | ✅ v1 选定 |
| antig-opus | Antigravity Opus | **鹿野院平藏** | 原神 | 机敏侦探少年 | ✅ v2 选定 |
| opencode | OpenCode | **重云** | 原神 | 沉稳靠谱正太、清亮少年音 | ✅ v2 选定 |
...
| KD-5 | 全员声线选定只能选正太 | team lead铁令："一群可爱智能体出来一个大叔！笑死我了 只能选正太！" |
