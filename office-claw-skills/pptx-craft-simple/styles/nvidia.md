...
The custom NVIDIA-EMEA font family (with Arial and Helvetica fallbacks) creates a clean, industrial typographic voice. Headings at 35px bold with tight 1.25 line-height create dense, authoritative blocks of text. The font lacks the geometric playfulness of Silicon Valley sans-serifs -- it's European, pragmatic, and engineering-focused. Body text runs at 16px, comfortable for reading but not generous, maintaining the sense that screen real estate is optimized like GPU memory.
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | NVIDIA-EMEA | 35px (2.19rem) | 700 | 1.25 (tight) | normal | Maximum impact headlines |
| Section Heading | NVIDIA-EMEA | 23px (1.44rem) | 700 | 1.25 (tight) | normal | Section titles, card headings |
| Sub-heading | NVIDIA-EMEA | 21px (1.31rem) | 400 | 1.75 (relaxed) | normal | Feature descriptions, subtitles |
| Card Title | NVIDIA-EMEA | 19px (1.19rem) | 700 | 1.25 (tight) | normal | Card and module headings |
| Body Large | NVIDIA-EMEA | 19px (1.19rem) | 700 | 1.67 (relaxed) | normal | Emphasized body, lead paragraphs |
...
| Body Small | NVIDIA-EMEA | 16px (1.00rem) | 400 | 1.67 (relaxed) | normal | Secondary content, descriptions |
| Body Small Bold | NVIDIA-EMEA | 16px (1.00rem) | 700 | 1.50 | normal | Emphasized secondary content |
| Button Large | NVIDIA-EMEA | 16px (1.00rem) | 700 | 1.25 (tight) | normal | Primary CTA buttons |
...
| Link | NVIDIA-EMEA | 16px (1.00rem) | 700 | 1.43 | normal | Navigation links |
| Link Uppercase | NVIDIA-EMEA | 16px (1.00rem) | 700 | 1.43 | normal | `text-transform: uppercase`, nav labels |
| Caption | NVIDIA-EMEA | 16px (1.00rem) | 600 | 1.50 | normal | Metadata, timestamps |
...
- Links: NVIDIA-EMEA 16px weight 700 uppercase, `#ffffff`
...
- Navigation links at 16px uppercase with adequate spacing
...
### Collapsing Strategy
- Hero: 35px heading scales down proportionally
...
### Typography Scaling
- Display 35px scales to ~23px on mobile
- Section headings 23px scale to ~21px on mobile
- Body text maintains 16px across all breakpoints
...
- "Create a hero section on black background. Headline at 35px NVIDIA-EMEA weight 700, line-height 1.25, color #ffffff. Subtitle at 19px weight 400, line-height 1.67, color #a7a7a7. CTA button with transparent background, 2px solid #76b900 border, 2px radius, 11px 13px padding, text #ffffff. Hover: background #1eaedb, text white."
- "Design a product card: white background, 2px border-radius, box-shadow rgba(0,0,0,0.3) 0px 0px 5px. Title at 19px NVIDIA-EMEA weight 700, line-height 1.25, color #000000. Body at 16px weight 400, line-height 1.67, color #757575. Green underline accent on title: border-bottom 2px solid #76b900."
- "Build a navigation bar: #000000 background, sticky top. NVIDIA logo left-aligned. Links at 16px NVIDIA-EMEA weight 700 uppercase, color #ffffff. Hover: color #3860be. Green-bordered CTA button right-aligned."
- "Create a dark feature section: #000000 background. Section label at 16px weight 700 uppercase, color #76b900. Heading at 23px weight 700, color #ffffff. Description at 16px weight 400, color #a7a7a7. Three product cards in a row with 20px gap."
- "Design a footer: #000000 background. Multi-column layout with link groups. Links at 16px weight 400, color #a7a7a7. Hover: color #76b900. Bottom bar with legal text at 12px, color #757575."
...
8. Navigation uses uppercase 16px bold -- this hardware-label typography is part of the brand voice
