...
The typography anchors everything. San Francisco (SF Pro Display for large sizes, SF Pro Text for body) is Apple's proprietary typeface, engineered with optical sizing that automatically adjusts letterforms depending on point size. At display sizes (35px), weight 600 with a tight line-height of 1.07 and subtle negative letter-spacing (-0.28px) creates headlines that feel machined rather than typeset — precise, confident, and unapologetically direct. At body sizes (19px), the tracking loosens slightly (-0.374px) and line-height opens to 1.47, creating a reading rhythm that is comfortable without ever feeling slack.
...
- SF Pro Display is used at 21px and above; SF Pro Text is optimized for 20px and below.

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | SF Pro Display | 35px (2.19rem) | 600 | 1.07 (tight) | -0.28px | Product launch headlines, maximum impact |
| Section Heading | SF Pro Display | 23px (1.44rem) | 600 | 1.10 (tight) | normal | Feature section titles |
| Tile Heading | SF Pro Display | 21px (1.31rem) | 400 | 1.14 (tight) | 0.196px | Product tile headlines |
...
| Nav Heading | SF Pro Text | 23px (1.44rem) | 600 | 1.47 | -0.374px | Large navigation headings |
| Sub-nav | SF Pro Text | 19px (1.19rem) | 300 | 1.50 | normal | Light sub-navigation text |
| Body | SF Pro Text | 19px (1.19rem) | 400 | 1.47 | -0.374px | Standard reading text |
| Body Emphasis | SF Pro Text | 19px (1.19rem) | 600 | 1.24 (tight) | -0.374px | Emphasized body text, labels |
| Button Large | SF Pro Text | 16px (1.00rem) | 300 | 1.00 (tight) | normal | Large button text, light weight |
| Button | SF Pro Text | 16px (1.00rem) | 400 | 2.41 (relaxed) | normal | Standard button text |
| Link | SF Pro Text | 16px (1.00rem) | 400 | 1.43 | -0.224px | Body links, "Learn more" |
| Caption | SF Pro Text | 16px (1.00rem) | 400 | 1.29 (tight) | -0.224px | Secondary text, descriptions |
| Caption Bold | SF Pro Text | 16px (1.00rem) | 600 | 1.29 (tight) | -0.224px | Emphasized captions |
...
- **Negative tracking at all sizes**: Unlike most systems that only track headlines, Apple applies subtle negative letter-spacing even at body sizes (-0.374px at 19px, -0.224px at 16px, -0.12px at 12px). This creates universally tight, efficient text.
...
- Product name as the primary headline (SF Pro Display, 35px, weight 600)
...
### Collapsing Strategy
- Hero headlines: 35px Display → 23px → 21px on mobile, maintaining tight line-height proportionally
...
- "Create a hero section on black background. Headline at 35px SF Pro Display weight 600, line-height 1.07, letter-spacing -0.28px, color white. One-line subtitle at 21px SF Pro Display weight 400, line-height 1.19, color white. Two pill CTAs: 'Learn more' (transparent bg, white text, 1px solid white border, 980px radius) and 'Buy' (Apple Blue #0071e3 bg, white text, 8px radius, 8px 15px padding)."
- "Design a product card: #f5f5f7 background, 8px border-radius, no border, no shadow. Product image top 60% of card on solid background. Title at 21px SF Pro Display weight 400, letter-spacing 0.196px, line-height 1.14. Description at 16px SF Pro Text weight 400, color rgba(0,0,0,0.8). 'Learn more' and 'Shop' links in #0066cc at 16px."
- "Build the Apple navigation: sticky, 48px height, background rgba(0,0,0,0.8) with backdrop-filter: saturate(180%) blur(20px). Links at 16px SF Pro Text weight 400, white text. Apple logo left, links centered, search and bag icons right."
- "Create an alternating section layout: first section black bg with white text and centered product image, second section #f5f5f7 bg with #1d1d1f text. Each section near full-viewport height with 35px headline and two pill CTAs below."
- "Design a 'Learn more' link: text #0066cc on light bg or #2997ff on dark bg, 16px SF Pro Text, underline on hover. After the text, include a right-arrow chevron character (>). Wrap in a container with 980px border-radius for pill shape when used as a standalone CTA."
...
4. Negative letter-spacing at all sizes: -0.28px at 35px, -0.374px at 19px, -0.224px at 16px, -0.12px at 12px
