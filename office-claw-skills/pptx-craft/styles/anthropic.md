...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | Anthropic Serif | 35px (2.19rem) | 500 | 1.10 (tight) | normal | Maximum impact, book-title presence |
| Section Heading | Anthropic Serif | 23px (1.44rem) | 500 | 1.20 (tight) | normal | Feature section anchors |
| Sub-heading Large | Anthropic Serif | 22–23px (~1.38rem) | 500 | 1.30 | normal | Secondary section markers |
| Sub-heading | Anthropic Serif | 21px (1.31rem) | 500 | 1.10 (tight) | normal | Card titles, feature names |
| Sub-heading Small | Anthropic Serif | 21px (1.31rem) | 500 | 1.20 | normal | Smaller section titles |
| Feature Title | Anthropic Serif | 19px (1.19rem) | 500 | 1.20 | normal | Small feature headings |
| Body Serif | Anthropic Serif | 16px (1.00rem) | 400 | 1.60 (relaxed) | normal | Serif body text (editorial passages) |
| Body Large | Anthropic Sans | 19px (1.19rem) | 400 | 1.60 (relaxed) | normal | Intro paragraphs |
| Body / Nav | Anthropic Sans | 16px (1.00rem) | 400–500 | 1.00–1.60 | normal | Navigation links, UI text |
| Body Standard | Anthropic Sans | 16px (1.00rem) | 400–500 | 1.25–1.60 | normal | Standard body, button text |
| Body Small | Anthropic Sans | 16px (1.00rem) | 400–500 | 1.00–1.60 | normal | Compact body text |
| Caption | Anthropic Sans | 16px (1.00rem) | 400 | 1.43 | normal | Metadata, descriptions |
...
| Code | Anthropic Mono | 16px (1.00rem) | 400 | 1.60 | -0.32px | Inline code, terminal |
...
| Desktop | 992px+ | Full multi-column layout, expanded nav, maximum hero typography (35px) |
...
- **Hero text**: 35px → 23px → 21px progressive scaling
...
- "Create a hero section on Parchment (#f5f4ed) with a headline at 35px Anthropic Serif weight 500, line-height 1.10. Use Anthropic Near Black (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 19px Anthropic Sans with 1.60 line-height. Place a Terracotta Brand (#c96442) CTA button with Ivory text, 12px radius."
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in Anthropic Serif at 21px weight 500, description in Olive Gray (#5e5d59) at 16px Anthropic Sans. Add a whisper shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
- "Build a dark section on Anthropic Near Black (#141413) with Ivory (#faf9f5) headline text in Anthropic Serif at 23px weight 500. Use Warm Silver (#b0aea5) for body text. Borders in Dark Surface (#30302e)."
...
- "Design a model comparison grid with three cards on Ivory surfaces. Each card gets a Border Warm (#e8e6dc) top border, model name in Anthropic Serif at 21px, and description in Olive Gray at 16px Anthropic Sans."
